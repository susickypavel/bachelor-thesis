...
Požadavek \hyperref[ofr12]{\fr{OFR 1.2}} u \texttt{createTooltipTrigger} vyžaduje jenom jediný atribut \texttt{"aria-describedby"}\footnote{\url{https://www.w3.org/TR/wai-aria/\#aria-describedby}}, který by měl nést hodnotu \texttt{id} atributu elementu s obsahem Tooltipu.
