...
% \begin{itemize}
%     \item \textbf{defaultVisible} --- Jestli má být obsah viditelný při prvním vykreslení (pro uncontrolled komponenty).
%     \item \textbf{id} --- HTML id elementu, který je otevírán a zavírán.
%     \item \textbf{isButtonElement} --- Tlačítko pro otevírání a zavírání obsahu nemusí být nutně HTML \texttt{button} element, ale pak je potřeba navázat správnou ARIA roli a další atributy pro správné fungování s odečítačem obrazovky.
%     \item \textbf{isVisible} ---
%     \item \textbf{onVisibilityChange} ---
% \end{itemize}
