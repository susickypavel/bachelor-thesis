...
\begin{lstlisting}[caption={Ukázka primitivní funkce s vnějším stavem (controlled stav)}, label={disclosure-controlled-vs-uncontrolled}, language=html]
...
\begin{figure}[htp]
    \centering
    \includegraphics[max size={\linewidth}{\textheight}]{./assets/figures/anatomy/tooltip.png}
    \captionsetup{justification=centering}
    \caption{Low-fidelity wireframe komponenty Tooltip}
\end{figure}

Pro splnění požadavku \hyperref[ofr11]{\fr{OFR 1.1}} je potřeba zajistit jedinou klávesovou interakci pomocí klávesy \texttt{Escape}, která uzavře obsah pokud je zobrazený.
