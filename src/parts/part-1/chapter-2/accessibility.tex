...
\section{W3C a Web Accessibility Initiative}
...
WAI definuje specifikace a doporučení pro mnohé aspekty přístupnosti na webu, od user agentů, evaluačních nástrojů a nástrojů pro tvorbu digitálního obsahu.
