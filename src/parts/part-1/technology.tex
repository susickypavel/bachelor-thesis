...
\begin{figure}[h]
  ...
  \captionsetup{justification=centering}
  \caption[Diagram abstrakce a flexibility různých přístupu k distribuci komponent]{Diagram abstrakce a flexibility různých přístupu k distribuci komponent (diagram autora)}
