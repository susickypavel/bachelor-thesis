...
\begin{itemize}
  \item \textbf{createSignal}\footnote{\url{https://docs.solidjs.com/reference/basic-reactivity/create-signal}} --- Vrací \textit{tuple} obsahující reaktivní proměnnou a její textit{setter} funkci.
...
Astro\footnote{\url{https://astro.build}} je \gls{ssg}, který používá vlastní syntaxi pro vytváření komponent.
...
Starlight funguje nad \texttt{MDX}\footnote{\url{https://mdxjs.com}}, což je formát, který umožňuje vkládat \gls{jsx} do markdown souborů.
