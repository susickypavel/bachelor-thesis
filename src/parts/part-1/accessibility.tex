...
\gls{waiaria}\footnote{\url{https://www.w3.org/TR/wai-aria}} je technická specifikace, která rožšiřuje webové technologie \gls{html} a JavaScript o ontologii atributů představující role, vlastnosti a stavy elementů~\cite{wai-aria}.
