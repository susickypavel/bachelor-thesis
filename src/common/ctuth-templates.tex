...
\begin{tabular}{@{}l@{\hspace*{1em}}l@{}}
	\Large\includegraphics[height=\dimexpr4\normalbaselineskip-1ex]{./assets/ctu_logo_black}
	 &
...
\ctutemplateset{twocolumn.lols}{
	\lstlistoflistings
}

\ctutemplateset{twocolumn.glossary}{
...
\ctutemplateset{maketitle.twocolumn.default}{
	\begin{twocolumnfrontmatterpage}
		...
		% } { }
		\clearpage
		\ctutemplate{twocolumn.lols}
		\newpage
		\ctutemplate{twocolumn.listoffigures}
		\clearpage
		\ctutemplate{twocolumn.listoftables}
		\newpage
		\ctutemplate{twocolumn.glossary}
